...
def make_ip_window():
    ...
    try:
        ...
        if platform == "vbox" and ip == "10.0.2.15":
                ...
                ip_win.addstr(10, 2, "or http://%s:%s" % ("127.0.0.1",sandbox_port))
                ip_win.addstr(11, 2, "To SSH into this VM use $ ssh kaa@%s -p 2222" % "127.0.0.1")
                ip_win.addstr(13, 2, "Also you can use bridged adapter networking mode.")
                ip_win.addstr(14, 2, "Follow this short tutorial for instructions on setting it up:")
                ip_win.addstr(15, 2, "https://youtu.be/ynbxcRdgXFU")
